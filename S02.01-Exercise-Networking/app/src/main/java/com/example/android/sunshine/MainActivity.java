       ...
       private void loadWeatherData(){
        ...
        public class Weather extends AsyncTask<String, Void, String[]> {
            ...
            protected String[] doInBackground(String... params) {
                ...
                try{
                    String jsonWeatherResp=NetworkUtils.getResponseFromHttpUrl(weatherReqURL);
                    String [] simpleJsonWeatherData= OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this,jsonWeatherResp);
